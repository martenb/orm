...
final class LikeFunction implements IArrayFilterFunction, IQueryBuilderFilterFunction
{
	...
	public function processQueryBuilderFilter(QueryBuilderHelper $helper, QueryBuilder $builder, array $args)
	{
		assert(count($args) === 2 && is_string($args[0]) && is_string($args[1]));
